  ...
  return (
    <>
      <Col xs={12} className="text-center">
        <h1 className="display-4 text-white mb-4 position-relative">{t('auth.welcome', locale)}</h1>
      ...
      <Col sm={10} md={8} lg={6} className="position-relative z-index-1">
        <Card className="card-body p-4 p-sm-5 mt-sm-n5 mb-n5">
          <div className="text-center">
            <h2 className="h1 mb-2">{t('auth.signUp', locale)}</h2>
            <span className="d-block">
              {t('auth.hasAccount', locale)}{' '}
              <Link href={`/${locale}/auth/sign-in`}>
                {t('auth.clickToSignIn', locale)}
              </Link>
            </span>
          </div>
