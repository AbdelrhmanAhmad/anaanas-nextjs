...
import { findAllParent, findMenuItem, getAppMenuItems, getMenuItemFromURL } 
from '@/helpers/menu'
...
<Link prefetch   href={item.url ?? ''} target={item.target} className={` nav-link dropdown-item ` +  linkClassName} >
